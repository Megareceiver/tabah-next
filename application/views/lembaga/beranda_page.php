    ...
    <div class="row">
      ...
      <div id="awal" class="col s12 m10 offset-m1">
        <ul class="collapsible popout" data-collapsible="accordion">
          <!-- <li>
            <div class="collapsible-header active"><i class="material-icons">receipt</i>Permohonan Bantuan Hibah 1<span class="new badge red" data-badge-caption="Verifikasi"></span></div>
            <div class="collapsible-body white">
              <div class="section">
                <h6 class="light">Informasi</h6>
                <div class="collection">
                  <a href="/kelembagaan/add/awal" class="collection-item"><span class="badge">#proposal123456</span>Nomor Dokumen</a>
                  <p class="collection-item modal-trigger"><span class="badge">Rp. 20,000,000</span>Total Pengajuan</p>
              ...
              <div class="section">
                ...
                <div class="collection">
                  ...
                  <a href="/kelembagaan/add/awal" class="collection-item"><span class="badge new red" data-badge-caption="belum"></span>Surat permohonan (.pdf)</a>
                  <a href="/kelembagaan/add/awal" class="collection-item"><span class="badge new red" data-badge-caption="belum"></span>Lampiran (.pdf)</a>
                </div>
              </div>
              <div class="section">
              ...
              <div class="section">
                ...
                <a href="#form-awal" class="btn red waves-effect waves-light modal-trigger">Ubah</a>
                <a href="/kelembagaan/add/awal" class="btn green darken-2 waves-effect waves-light">Lengkapi</a>
              </div>
            </div>
          </li>
          <li>
            <div class="collapsible-header"><i class="material-icons">receipt</i>Permohonan Bantuan Hibah 1<span class="new badge" data-badge-caption="Selesai"></span></div>
            <div class="collapsible-body white">
              <div class="section">
                <h6 class="light">Informasi</h6>
                <div class="collection">
                  <p class="collection-item"><span class="badge">#proposal1234888</span>Nomor Dokumen</p>
                  <p class="collection-item"><span class="badge">Rp. 20,000,000</span>Total Pengajuan</p>
                  <p class="collection-item">Lorem ipsum dolor sit amet.Lorem ipsum dolor sit amet Lorem ipsum dolor sit amet. Lorem ipsum dolor sit amet Lorem ipsum dolor sit amet.</p>
