            ...
            <?php foreach ($daftar_persyaratan as $persyaratan) { ?>
              ...
              <li>
                ...
                <div class="collapsible-body white">
                  <?php if ($status != "Belum") { ?>
                  <div class="row">
                    Berkas : <a href="/uploads/permohonan_awal/<?=$persyaratan->berkas?>" target="_blank"><?=$persyaratan->berkas?></a>
                  </div>
                  <div class="row">
                    <a href="/kelembagaan/delete_persyaratan/awal/<?=$nomor_dokumen?>/<?=$persyaratan->kode_data?>" class="btn-flat grey-text"><i class="material-icons left">delete</i>Hapus berkas</a>
                  </div>
                  <?php } else { ?>
                  <form action="/kelembagaan/upload_persyaratan/awal/<?=$nomor_dokumen?>/<?=$persyaratan->kode_data?>" method="post" enctype="multipart/form-data" accept-charset="utf-8">
                  ...
                  <tbody>
                    <?php if(!empty($daftar_rab)){ $total = 0; ?>
                      ...
                      <tr>
                        ...
                        <td><a href="/kelembagaan/delete_rab/awal/<?=$nomor_dokumen?>/<?=$rab->kode_data?>" class="grey-text"><i class="material-icons left">delete</i></a></td>
                      </tr>
                      <?php } ?>
                    <?php }else { ?>
                      <tr>
